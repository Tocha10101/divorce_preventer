...
class TreeCreator:
    ...
    def calculateGini(self, selectedFeature, threshold, specimenList, wanna_print=False):
        ...
        #print(f"leftGini LF {leftFalse} LT {leftTrues} RF {rightFalse} RT {rightTrues} Threshold = {threshold} FEATURE: {selectedFeature}")
        if (leftTrues+leftFalse == 0) | (rightTrues + rightFalse == 0):
            ...
            try:
                ...
                pass
                print(f"rightGini LF {leftFalse} LT {leftTrues} RF {rightFalse} RT {rightTrues} Threshold= {threshold} FEATURE: {selectedFeature}")
